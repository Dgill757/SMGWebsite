...
- Production timing QA showed a newly created public alias can take roughly 25 seconds to route after the deployment reports ready. The readiness gate now allows 60 seconds and never publishes a dead link prematurely.
