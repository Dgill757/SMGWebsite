      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-16">
          <h2 className="heading-lg">
            Stop Losing <span className="text-gradient">$10,000s</span> in Missed Opportunities
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            <div 
              key={index}
              className="bg-white dark:bg-voiceai-dark/40 rounded-xl p-6 shadow-lg card-hover border border-border relative overflow-hidden"
            >
