        ...
        <div className="w-full flex justify-between items-center px-6 lg:px-12">
          ...
          <div className="flex items-center flex-shrink-0">
            <Link to="/" className="flex items-center space-x-3" onClick={() => window.scrollTo(0, 0)}>
              ...
              <span className="font-bold text-2xl bg-gradient-to-r from-voiceai-primary to-voiceai-secondary bg-clip-text text-transparent whitespace-nowrap">SummitVoiceAI</span>
            </Link>
            <span className="text-sm text-foreground/70 font-medium bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent ml-4 hidden xl:block whitespace-nowrap">The Future of Websites Is Here</span>
          </div>
          
          {/* Navigation Links - Desktop - All in one line */}
          <div className="hidden lg:flex items-center justify-end space-x-6 xl:space-x-8 flex-grow">
            <a 
              href="#features" 
              onClick={(e) => scrollToSection('features', e)} 
              className="navbar-tab-link relative group whitespace-nowrap"
            >
              Features
            </a>
            <a 
            ...
            <a 
              href="#pricing" 
              onClick={(e) => scrollToSection('pricing', e)} 
              className="navbar-btn-primary bg-gradient-to-r from-purple-600 to-cyan-500 hover:from-purple-500 hover:to-cyan-400 text-white font-semibold px-6 py-3 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-purple-500/30 relative overflow-hidden group whitespace-nowrap"
            >
