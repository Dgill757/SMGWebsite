...
const IndustryTestimonial = ({ 
  ...
  return (
    <section className="py-16" style={{ background: 'linear-gradient(135deg, rgba(0,217,255,0.08), rgba(124,58,237,0.08))' }}>
      <div className="container mx-auto px-4">
        ...
        <div className="glass rounded-2xl overflow-hidden max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            {/* Image and Info */}
            <div className="relative h-full min-h-[300px] lg:min-h-[400px]" style={{ background: 'linear-gradient(135deg, #00D9FF, #7C3AED)' }}>
            ...
            <div className="p-8 lg:p-12 flex flex-col justify-between">
              <div>
                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="mb-6 opacity-30" style={{ color: '#00D9FF' }}>
                ...
                <div className="grid grid-cols-3 gap-4">
                  {metrics.map((metric, index) => (
                    <div key={index} className="glass text-center p-3 rounded-lg">
                      <p className="text-xl lg:text-2xl font-bold" style={{ color: '#00D9FF' }}>{metric.value}</p>
